# 2023-03-10 - SOA北美精算师超实用备考计划——Exam FAM精算数学基础
...
💥最全的新手精算上路指南来了！手把手教你备考SOA，今天为大家带来的是《Exam FAM备考计划》，建议收藏！先Mark再看！

**👉 考试科目：**Exam FAM

**👉 考试日期：**

![图片](https://mmbiz.qpic.cn/mmbiz_png/mK3FpI9af4mibfkmkCVTc7M83j6bS7jqpLNxg6rKtkibdKxNWoVEIDAibfjxPdv5lP3NOYmpvkeUaVmFXtHvwicIqg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
2、严重性、频率和聚合模型(12.5-15%)

3、参数和非参数估计(5-10%)

4、可信概论(2.5-5%)

5、短期保险的定价及预留(7.5-12.5%)

6、期权定价基础(2.5-7.5%)

FAML

1、保险范围和退休财务保障计划(2.5-7.5%)
...
**学习网校视频课程，结合教材讲义，梳理知识点，做好笔记。**ASM Manual FAMS 30个lesson +FAML42个lesson合计72个，一天一个lesson。争取2个月内看完所有的lesson。时间较紧张，学习知识点、例题并尽可能完成课后习题，做笔记总结。如果你能把这一个知识点的题目都做一遍，自己总结一遍出题方法和考题形式，你后面碰到类似的题目，一眼就能看出来，这到底是在考哪个知识点，套路是什么。看了答案后还不是很理解的题目在网校积极提问，有专业老师答疑。 
...
**Part 4****Sample Questions（约需至少8天）**

SOA Sample Questions共119题，本着做经典习题，精细做题的原则，把Sample Questions上每一道都做清楚、做明白，即使正确的题，也要看官方解题思路，把每一道题当作例题来做。每天至少弄通15题，预计约需8天完成Sample Questions，不断刷题，训练读题速度和做题效率。之后再使用至少三天，对之前的重点题目进行全盘回顾。

做题正确率能达到百分之70-80左右。重要的还是要多做题，然后公式都记住，就没有什么问题。
